<!-- HTML (historico_logistica_distribuicao.php) -->
...
<head>
    ...
    <title>Histórico Logística Distribuição de Veículos</title>
...
<body>
    ...
    <div class="container">
        <h2>Histórico Logística Distribuição de Veículos</h2>
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                echo "<tr>
                        <td>" . $row["timestamp"] . "</td>
                        <td>" . $row["id_logistica_veiculo"] . "</td>
                        <td>" . $row["acao"] . "</td>
                      </tr>";
            }
            ...
            echo "Nenhum registro encontrado no histórico de Logística Distribuição de Veículos.";
        }
