<!-- HTML (historico_producao_veiculos.php) -->
...
<head>
    ...
    <title>Histórico Produção de Veículos</title>
...
<body>
    ...
    <div class="container">
        <h2>Histórico Produção de Veículos</h2>
        ...
        $sql = "SELECT * FROM log_producao_veiculos";
        ...
        if ($result->num_rows > 0) {
            ...
            echo "Nenhum registro encontrado no histórico de Produção Veículos.";
        }
